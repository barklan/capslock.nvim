...
M.toggle = function(mode)
    ...
    if mode == "i" and M.enabled("n") then
        return M.disable("n")
    end
...
M.setup = function()
    vim.keymap.set("n", M.keybinding_const, function()
        M.toggle("n")
    end, { silent = true })
    vim.keymap.set("i", M.keybinding_const, function()
        M.toggle("i")
    end, { silent = true })
    vim.keymap.set("c", M.keybinding_const, function()
        M.toggle("c")
    end, { silent = true })
